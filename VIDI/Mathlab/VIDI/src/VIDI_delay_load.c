 ...
 */
FARPROC WINAPI VIDIDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = VIDIDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = VIDIDelayLoadWin32FailureHook;
#endif
